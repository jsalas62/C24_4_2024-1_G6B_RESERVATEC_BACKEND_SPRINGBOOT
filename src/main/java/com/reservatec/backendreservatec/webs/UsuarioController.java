...
public class UsuarioController {
    ...
    public ResponseEntity<Void> checkUserStatus(OAuth2AuthenticationToken token, Authentication authentication) {
        ...
        String redirectUrl = usuarioRegistrado ? "https://balanced-delight-production.up.railway.app/inicio" : "https://balanced-delight-production.up.railway.app/register";
